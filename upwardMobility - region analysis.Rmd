---
title: "Upward Mobility - region analysis"
author: "Alex Haase"
output:
...
```
#Creating Dataframes and Generating Confidence Intervals
```{r}
zone = mobility$zone
...
Note: p_upmover and n_lowstart are vectors for proportions for all the cities and their sample sizes 
...
#compare test stat to chi-square on 3 degree's of freedom
